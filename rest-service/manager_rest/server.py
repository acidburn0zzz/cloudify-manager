...
def init_secured_app(_app):
    ...
    def register_userstore_driver(userstore_driver):
        ...
        secure_app.set_userstore_driver(create_instance(userstore_driver))
